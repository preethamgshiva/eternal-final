  ...
  return (
    <div className="min-h-screen bg-gray-100 text-black relative z-30">
      <div className="flex flex-col items-center justify-center min-h-screen p-10 text-center">
        <h2 className="text-5xl lg:text-7xl font-bold mb-6">A New Beginning</h2>
        <p className="text-xl text-gray-700 max-w-2xl">
          This third section scrolls over the *second* sticky section.
        </p>
      </div>
      ...
      <div className="h-screen p-10">
        ...
        <p className="text-center text-gray-600 mt-4">
          This ensures the page has enough length to scroll.
        </p>
      </div>
    </div>
  );
